package javaOnlineRu.L14_BlockingThreads;

import java.util.*;
import java.util.concurrent.LinkedBlockingDeque;

public class LinkedBlockingDequeExample {
    final String EXTRACT     = "Extracting from map : %s%n";
    final String INSERT      = "Adding to que : %s%n";
    final String WAIT        = "... waiting : %s%n";
    ...
    LinkedBlockingDequeExample() {
        ...
        System.out.printf("Collection list : %s%n",names);
